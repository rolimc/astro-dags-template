...
def load_to_bigquery(data_dict: dict) -> None:
    ...
    # Imports dentro do task para não quebrar o parse
    import json
    ...
    # ===== credenciais a partir da conexão do Airflow =====
    conn = BaseHook.get_connection(GCP_CONN_ID)
    extra = conn.extra_dejson or {}
    credentials = None

    if extra.get("keyfile_dict"):
